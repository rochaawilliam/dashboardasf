...
export const subcategories: Record<MetricCategory, SubcategoryConfig[]> = {
  ...
  experiencia_cliente: [
    { name: "Satisfação do Cliente", keywords: ["NPS", "Churn de Clientes"], order: 1 },
    { name: "Retenção e Lifetime", keywords: ["Lifetime", "Lead Time de Onboarding", "Taxa de Onboarding"], order: 2 },
    { name: "Contratos - Empresarial", keywords: ["Contratos Empresarial"], order: 3 },
    { name: "Contratos - Tributário", keywords: ["Contratos Tributário"], order: 4 },
    { name: "Contratos - Trabalhista", keywords: ["Contratos Trabalhista"], order: 5 },
