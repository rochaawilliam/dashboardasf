...
export const subcategories: Record<MetricCategory, SubcategoryConfig[]> = {
  ...
  experiencia_cliente: [
    { name: "Contratos - Empresarial", keywords: ["Contratos Empresarial"], excludeKeywords: ["Mês Anterior"], order: 1 },
    { name: "Contratos Empresariais - Mês Anterior", keywords: ["Contratos Empresariais Mês Anterior"], order: 2 },
    { name: "Contratos - Tributário", keywords: ["Contratos Tributário"], order: 3 },
    { name: "Contratos - Trabalhista", keywords: ["Contratos Trabalhista"], excludeKeywords: ["Mês Anterior"], order: 4 },
    { name: "Contratos Trabalhista - Mês Anterior", keywords: ["Contratos Trabalhista Mês Anterior"], order: 5 },
    { name: "Contratos - Patenteia", keywords: ["Contratos Patenteia", "Total Contratos"], order: 6 },
