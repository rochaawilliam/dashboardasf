...
export const subcategories: Record<MetricCategory, SubcategoryConfig[]> = {
  ...
  experiencia_cliente: [
    { name: "Contratos - Empresarial", keywords: ["Contratos Empresarial", "Total Contratos Assessoria Empresarial"], order: 1 },
    { name: "Contratos - Tributário", keywords: ["Contratos Tributário"], order: 3 },
    { name: "Contratos - Trabalhista", keywords: ["Contratos Trabalhista", "Total Contratos Assessoria Trabalhista"], order: 4 },
