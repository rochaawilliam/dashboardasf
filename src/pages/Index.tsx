...
const Index = () => {
  ...
  const pipelineAccumulatedValues = useMemo(() => {
    ...
    if (dbo?.online) values["e1f2a3b4-1111-4eee-ffff-111111111111"] = dbo.online.leads;
    if (dbo?.offline) values["e1f2a3b4-2222-4eee-ffff-222222222222"] = dbo.offline.leads;
